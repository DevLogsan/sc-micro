<?php
$infos ='<div style="background-color: #043e6b;" class="btn btn-primary"> Modifier le mot de passe <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-fingerprint" viewBox="0 0 16 16">
...
<form method="post" action="<?php echo site_url('Utilisateurs/modification-utilisateur/'.$value->utilisateur_id)?>" class="row g-3">
